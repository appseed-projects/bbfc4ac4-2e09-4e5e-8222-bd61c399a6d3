...
- Timestamp: `2022-07-09 04:58`
- Build ID: `bbfc4ac4-2e09-4e5e-8222-bd61c399a6d3`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bbfc4ac4-2e09-4e5e-8222-bd61c399a6d3.git
$ cd bbfc4ac4-2e09-4e5e-8222-bd61c399a6d3
```
